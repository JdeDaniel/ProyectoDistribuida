...
Descripción:
Implementar un sistema en XML-RPC como mecanismo de comunicación entre procesos que contenga:
 ...
 * Los clientes reportan resultados una vez terminado: 
     Tabla de resumen de procesos (nombre, tiempo de petición, tiempo de asignación, tiempo de término) 
     Para calcular se usa:
 
     1. Finalización: F= t + E 
     Donde t es tiempo de CPU.Efecto en el tiempo de ejecución del proceso 

     2. E es tiempo de espera. Efecto en el tiempo de un proceso en Estado Listo 

     3. Espera E = F - t 
     Donde E es la espera 
     F es el tiempo de respuesta o finalizacion. Efecto en el tiempo total para completar el proceso 
 
     4. Penalizacion P = F / t 
     Donde P es penalizacion
